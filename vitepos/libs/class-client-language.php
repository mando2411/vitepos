...
if ( ! class_exists( __NAMESPACE__ . '\Client_Language' ) ) {
	...
	class Client_Language {
		...
		public static function get_admin_languages( &$kernel_object ) {
			...
			$language['Token Prefix']                                                                                                                                                                                                                                                                                                                      = $kernel_object->__( 'Token Prefix' );
			$language['Enable token resetting everyday']                                                                                                                                                                                                                                                                                                   = $kernel_object->__( 'Enable token resetting everyday' );
			$language['Reset Time']                                                                                                                                                                                                                                                                                                                        = $kernel_object->__( 'Reset Time' );
			...
			$language['Token no label']                                                                                                                                                                                                                                                                                                                    = $kernel_object->__( 'Token no label' );
			$language['Token Position']                                                                                                                                                                                                                                                                                                                    = $kernel_object->__( 'Token Position' );
			$language['Qrcode']                                                                                                                                                                                                                                                                                                                            = $kernel_object->__( 'Qrcode' );
			...
			$language['Show Available Label']                                                                                                                                                                                                                                                                                                              = $kernel_object->__( 'Show Available Label' );
			$language['Order Used Point Label']                                                                                                                                                                                                                                                                                                            = $kernel_object->__( 'Order Used Point Label' );
			$language['Order Received Point Label']                                                                                                                                                                                                                                                                                                        = $kernel_object->__( 'Order Received Point Label' );

			
			$language['Sync Settings']                                                                                                                                 = $kernel_object->__( 'Sync Settings' );
			$language['When Pusher Is Enabled']                                                                                                                        = $kernel_object->__( 'When Pusher Is Enabled' );
			$language['When Pusher Is Not Enabled']                                                                                                                    = $kernel_object->__( 'When Pusher Is Not Enabled' );
			$language['Product Sync Interval']                                                                                                                         = $kernel_object->__( 'Product Sync Interval' );
			$language['Order Sync Interval']                                                                                                                           = $kernel_object->__( 'Order Sync Interval' );
			$language['To get more benefits, enabling the pusher to reduce the load on your server is recommended. The free pusher package should be enough for you.'] = $kernel_object->__( 'To get more benefits, enabling the pusher to reduce the load on your server is recommended. The free pusher package should be enough for you.' );
			...
			$language['Order Total Rounding Type']                                                                                                                                          = $kernel_object->__( 'Order Total Rounding Type' );
			$language['Standard price round']                                                                                                                                               = $kernel_object->__( 'Standard price round' );
			$language['Conditional price round']                                                                                                                                            = $kernel_object->__( 'Conditional price round' );
			$language['Amounts will be rounded using a custom method: values ending in .5 remain unchanged, amounts below .5 are rounded down, and amounts above .5 are rounded up.']       = $kernel_object->__( 'Amounts will be rounded using a custom method: values ending in .5 remain unchanged, amounts below .5 are rounded down, and amounts above .5 are rounded up.' );
			$language['Amounts are rounded to the nearest whole number using standard rounding rules (e.g., values ending in .5 or higher are rounded up, and below .5 are rounded down).'] = $kernel_object->__( 'Amounts are rounded to the nearest whole number using standard rounding rules (e.g., values ending in .5 or higher are rounded up, and below .5 are rounded down).' );

			
			$language['Restaurant basic mode allows the cashier to manage table-wise orders from the POS panel, assign orders to tables, print kitchen slips directly (with no separate kitchen panel), and perform checkout from the same interface.'] = $kernel_object->__( 'Restaurant basic mode allows the cashier to manage table-wise orders from the POS panel, assign orders to tables, print kitchen slips directly (with no separate kitchen panel), and perform checkout from the same interface.' );
			$language['Show token no']                                                                                                                                                                                                                  = $kernel_object->__( 'Show token no' );
			$language['Token no label']                                                                                                                                                                                                                 = $kernel_object->__( 'Token no label' );
			$language['Token Position']                                                                                                                                                                                                                 = $kernel_object->__( 'Token Position' );
			...
			$language['Swipe Settings']                                                                                                            = $kernel_object->__( 'Swipe Settings' );
			$language['Stripe Terminal']                                                                                                           = $kernel_object->__( 'Stripe Terminal' );
			$language['Wallee Settings']                                                                                                           = $kernel_object->__( 'Wallee Settings' );
			$language['Woocomerce Payment']                                                                                                        = $kernel_object->__( 'Woocomerce Payment' );
			$language['Custom Methods']                                                                                                            = $kernel_object->__( 'Custom Methods' );
			$language['It will allows to take payment using %{brand} payment methods.']                                                            = $kernel_object->__( 'It will allows to take payment using %{brand} payment methods.' );
			$language['Swipe']                                                                                                                     = $kernel_object->__( 'Swipe' );
			$language['Is Required Card Last 4 Digit']                                                                                             = $kernel_object->__( 'Is Required Card Last 4 Digit' );
			$language['Capture on order complete (Recommended)']                                                                                   = $kernel_object->__( 'Capture on order complete (Recommended)' );
			$language['Map With Readers']                                                                                                          = $kernel_object->__( 'Map With Readers' );
			$language['Stripe Info Missing']                                                                                                       = $kernel_object->__( 'Stripe Info Missing' );
			$language['Wallee']                                                                                                                    = $kernel_object->__( 'Wallee' );
			$language['Space Id']                                                                                                                  = $kernel_object->__( 'Space Id' );
			$language['User Id']                                                                                                                   = $kernel_object->__( 'User Id' );
			$language['Select Woocommerce Payements']                                                                                              = $kernel_object->__( 'Select Woocommerce Payements' );
			$language['Below is the list of all active WooCommerce payment gateways. Please select the payment gateways you want to use for POS.'] = $kernel_object->__( 'Below is the list of all active WooCommerce payment gateways. Please select the payment gateways you want to use for POS.' );
			$language['Direct bank transfer']                                                                                                      = $kernel_object->__( 'Direct bank transfer' );
			$language['Check payments']                                                                                                            = $kernel_object->__( 'Check payments' );
			$language['Cash on delivery']                                                                                                          = $kernel_object->__( 'Cash on delivery' );

			
			$language['Add item to an existing order']                                                                                                                                                          = $kernel_object->__( 'Add item to an existing order' );
			$language['Remove item from an existing order']                                                                                                                                                     = $kernel_object->__( 'Remove item from an existing order' );
			$language['Enable this option to allow adding new items to an existing order. Once added, sending the updated order to the kitchen will be the responsibility of the cashier who added the items.'] = $kernel_object->__( 'Enable this option to allow adding new items to an existing order. Once added, sending the updated order to the kitchen will be the responsibility of the cashier who added the items.' );
			$language['Enable this option to allow removing items from an existing order. Once removed, ensuring the kitchen is updated will be the responsibility of the cashier who made the change.']        = $kernel_object->__( 'Enable this option to allow removing items from an existing order. Once removed, ensuring the kitchen is updated will be the responsibility of the cashier who made the change.' );
			$language['Use camera on barcode scanning']                                                                                                                                                         = $kernel_object->__( 'Use camera on barcode scanning' );
			$language['Mobile Screen']                                                                                                                                                                          = $kernel_object->__( 'Mobile Screen' );
			$language['Large Screen']                                                                                                                                                                           = $kernel_object->__( 'Large Screen' );
			$language['Enable Token No']                                                                                                                                                                        = $kernel_object->__( 'Enable Token No' );
			...
			$language['Token No']                                                                                                                                                                               = $kernel_object->__( 'Token No' );
			$language['Vat No']                                                                                                                                                                                 = $kernel_object->__( 'Vat No' );
			$language['ID']                                                                                                                                                                                     = $kernel_object->__( 'ID' );
			$language['Show Available Reward Points']                                                                                                                                                           = $kernel_object->__( 'Show Available Reward Points' );
			$language['Show Available Label']                                                                                                                                                                   = $kernel_object->__( 'Show Available Label' );
			$language['Available Points']                                                                                                                                                                       = $kernel_object->__( 'Available Points' );
			$language['Show Order Used Points']                                                                                                                                                                 = $kernel_object->__( 'Show Order Used Points' );
			$language['Order Used Point Label']                                                                                                                                                                 = $kernel_object->__( 'Order Used Point Label' );
			$language['Order Used Points']                                                                                                                                                                      = $kernel_object->__( 'Order Used Points' );
			$language['Show Order Received Points']                                                                                                                                                             = $kernel_object->__( 'Show Order Received Points' );
			$language['Order Received Point Label']                                                                                                                                                             = $kernel_object->__( 'Order Received Point Label' );
			$language['Order Received Points']                                                                                                                                                                  = $kernel_object->__( 'Order Received Points' );
			...
			$language['No change for update']                                                                                   = $kernel_object->__( 'No change for update' );
			$language['Saved Successfully']                                                                                     = $kernel_object->__( 'Saved Successfully' );
			$language['Captcha error, please try again']                                                                        = $kernel_object->__( 'Captcha error, please try again' );
			$language['No lined outlet found']                                                                                  = $kernel_object->__( 'No lined outlet found' );
			$language['Different linked outlet found in database. Would you please save the setting before transfer the stock'] = $kernel_object->__( 'Different linked outlet found in database. Would you please save the setting before transfer the stock' );
			...
			$language['Do you want to skip the %{plugin_name} plugin in Vitepos API requests?']              = $kernel_object->__( 'Do you want to skip the %{plugin_name} plugin in Vitepos API requests?' );

			
			$language['Enable Drawer Previous Amount']                          = $kernel_object->__( 'Enable Drawer Previous Amount' );
			$language['Is the Drawer Previous Amount required before closing?'] = $kernel_object->__( 'Is the Drawer Previous Amount required before closing?' );


			
			$language['Hide Out-of-Stock Products']                                            = $kernel_object->__( 'Hide Out-of-Stock Products' );
			$language['Enable this option to hide zero stock items from the POS product list'] = $kernel_object->__( 'Enable this option to hide zero stock items from the POS product list' );
			$language['Token font size(px)']                                                   = $kernel_object->__( 'Token font size(px)' );

			
			$language['Enable Counted Amount Input on Drawer Close']                                                                 = $kernel_object->__( 'Enable Counted Amount Input on Drawer Close' );
			$language['Require Counted Cash Input Before Drawer Close']                                                              = $kernel_object->__( 'Require Counted Cash Input Before Drawer Close' );
			$language['Allows users to input the counted cash amount before closing the drawer.']                                    = $kernel_object->__( 'Allows users to input the counted cash amount before closing the drawer.' );
			$language['Allows users to enter the counted cash amount before closing the drawer to ensure accurate cash management.'] = $kernel_object->__( 'Allows users to enter the counted cash amount before closing the drawer to ensure accurate cash management.' );
		...
		public static function get_pos_languages( &$kernel_object ) {
			...
			$language['Generate']                                                                                  = $kernel_object->__( 'Generate' );
			...
			$language['Choose/Search Table']                                                                       = $kernel_object->__( 'Choose/Search Table' );
			$language['Contact No']                                                                                = $kernel_object->__( 'Contact No' );
			...
			$language['Font Size']                                    = $kernel_object->__( 'Font Size' );
			$language['Price Font Size']                              = $kernel_object->__( 'Price Font Size' );
			$language['Note Font Size']                               = $kernel_object->__( 'Note Font Size' );
			...
			$language['PDF']                                = $kernel_object->__( 'PDF' );
			$language['Reports']                            = $kernel_object->__( 'Reports' );
			$language['Total Order']                        = $kernel_object->__( 'Total Order' );
			$language['Total Refund']                       = $kernel_object->__( 'Total Refund' );
			$language['Payment Methods']                    = $kernel_object->__( 'Payment Methods' );
			$language['Top Products']                       = $kernel_object->__( 'Top Products' );
			$language['Top Customers']                      = $kernel_object->__( 'Top Customers' );
			$language['Top Cashier']                        = $kernel_object->__( 'Top Cashier' );
			$language['Daily Report']                       = $kernel_object->__( 'Daily Report' );
			$language['Staffs']                             = $kernel_object->__( 'Staffs' );
			$language['Top 10 Product']                     = $kernel_object->__( 'Top 10 Product' );
			$language['Top 10 Customer']                    = $kernel_object->__( 'Top 10 Customer' );
			$language['Sales Quantity']                     = $kernel_object->__( 'Sales Quantity' );
			$language['Refund Quantity']                    = $kernel_object->__( 'Refund Quantity' );
			$language['Total Orders']                       = $kernel_object->__( 'Total Orders' );
			$language['Total Refunds']                      = $kernel_object->__( 'Total Refunds' );
			$language['Total Purchase']                     = $kernel_object->__( 'Total Purchase' );
			$language['Report loading']                     = $kernel_object->__( 'Report loading' );
			$language['Order ID']                           = $kernel_object->__( 'Order ID' );
			$language['Ordered Date']                       = $kernel_object->__( 'Ordered Date' );
			$language['Customer']                           = $kernel_object->__( 'Customer' );
			$language['Enter Value']                        = $kernel_object->__( 'Enter Value' );
			$language['Order Count']                        = $kernel_object->__( 'Order Count' );
			$language['Sale Amount']                        = $kernel_object->__( 'Sale Amount' );
			$language['Order Report Summary']               = $kernel_object->__( 'Order Report Summary' );
			$language['Refund Report Summary']              = $kernel_object->__( 'Refund Report Summary' );
			$language['Payment Method Report Summary']      = $kernel_object->__( 'Payment Method Report Summary' );
			$language['Cashier Report Summary']             = $kernel_object->__( 'Cashier Report Summary' );
			$language['Customer Report Summary']            = $kernel_object->__( 'Customer Report Summary' );
			$language['Product Report Summary']             = $kernel_object->__( 'Product Report Summary' );
			$language['Top 10 Order']                       = $kernel_object->__( 'Top 10 Order' );
			$language['Top 10 Refund']                      = $kernel_object->__( 'Top 10 Refund' );
			$language['Top Cashier List']                   = $kernel_object->__( 'Top Cashier List' );
			$language['Top Payment Methods']                = $kernel_object->__( 'Top Payment Methods' );
			$language['Order Date']                         = $kernel_object->__( 'Order Date' );
			$language['Order Id']                           = $kernel_object->__( 'Order Id' );
			$language['Order Amount']                       = $kernel_object->__( 'Order Amount' );
			$language['Payment Type']                       = $kernel_object->__( 'Payment Type' );
			$language['Total Amount']                       = $kernel_object->__( 'Total Amount' );
			$language['Customer Name']                      = $kernel_object->__( 'Customer Name' );
			$language['Item Sold']                          = $kernel_object->__( 'Item Sold' );
			$language['Report']                             = $kernel_object->__( 'Report' );
			$language['All Order Data']                     = $kernel_object->__( 'All Order Data' );
			$language['Top 100 Product Data']               = $kernel_object->__( 'Top 100 Product Data' );
			$language['All Customer Data']                  = $kernel_object->__( 'All Customer Data' );
			$language['All Staff Data']                     = $kernel_object->__( 'All Staff Data' );
			$language['Product Info']                       = $kernel_object->__( 'Product Info' );
			$language['Export Excel']                       = $kernel_object->__( 'Export Excel' );
			$language['Export CSV']                         = $kernel_object->__( 'Export CSV' );
			$language['Please add customer to add rewards'] = $kernel_object->__( 'Please add customer to add rewards' );
			$language['Please add items to apply coupons']  = $kernel_object->__( 'Please add items to apply coupons' );

			
			$language['Token No']              = $kernel_object->__( 'Token No' );
			$language['Reward Points']         = $kernel_object->__( 'Reward Points' );
			$language['Available Points']      = $kernel_object->__( 'Available Points' );
			$language['Max usage']             = $kernel_object->__( 'Max usage' );
			$language['Conversion rate']       = $kernel_object->__( 'Conversion rate' );
			$language['Order Used Points']     = $kernel_object->__( 'Order Used Points' );
			$language['Order Received Points'] = $kernel_object->__( 'Order Received Points' );
			$language['Placed Order']          = $kernel_object->__( 'Placed Order' );

			
			$language['Round Factor'] = $kernel_object->__( 'Round Factor' );

			
			$language['Basic POS']                                             = $kernel_object->__( 'Basic POS' );
			$language['Select waiter']                                         = $kernel_object->__( 'Select waiter' );
			$language['No waiter']                                             = $kernel_object->__( 'No waiter' );
			$language['Make Order']                                            = $kernel_object->__( 'Make Order' );
			$language['Order details loading']                                 = $kernel_object->__( 'Order details loading' );
			$language['Print Kitchen Receipt']                                 = $kernel_object->__( 'Print Kitchen Receipt' );
			$language['Print kitchen slip']                                    = $kernel_object->__( 'Print kitchen slip' );
			$language['Table Order List']                                      = $kernel_object->__( 'Table Order List' );
			$language['Add New Order']                                         = $kernel_object->__( 'Add New Order' );
			$language['Time Spent']                                            = $kernel_object->__( 'Time Spent' );
			$language['Select number of guest to create order (Seat Capacity'] = $kernel_object->__( 'Select number of guest to create order (Seat Capacity' );

			
			$language['Attribute']                                                                     = $kernel_object->__( 'Attribute' );
			$language['Product Attribute']                                                             = $kernel_object->__( 'Product Attribute' );
			$language['Add Attribute']                                                                 = $kernel_object->__( 'Add Attribute' );
			$language['Terms']                                                                         = $kernel_object->__( 'Terms' );
			$language['Update Product Attribute']                                                      = $kernel_object->__( 'Update Product Attribute' );
			$language['Add Product Attribute']                                                         = $kernel_object->__( 'Add Product Attribute' );
			$language['Add New']                                                                       = $kernel_object->__( 'Add New' );
			$language['Term Name']                                                                     = $kernel_object->__( 'Term Name' );
			$language['Term Description']                                                              = $kernel_object->__( 'Term Description' );
			$language['Loading attribute']                                                             = $kernel_object->__( 'Loading attribute' );
			$language['Attribute Loading ...']                                                         = $kernel_object->__( 'Attribute Loading ...' );
			$language['No Terms Added']                                                                = $kernel_object->__( 'No Terms Added' );
			$language['Parent Category']                                                               = $kernel_object->__( 'Parent Category' );
			$language['Add Category']                                                                  = $kernel_object->__( 'Add Category' );
			$language['Add Product Category']                                                          = $kernel_object->__( 'Add Product Category' );
			$language['Category Loading ...']                                                          = $kernel_object->__( 'Category Loading ...' );
			$language['Loading category']                                                              = $kernel_object->__( 'Loading category' );
			$language['Product Category']                                                              = $kernel_object->__( 'Product Category' );
			$language['Choose Parent Category']                                                        = $kernel_object->__( 'Choose Parent Category' );
			$language['Category description']                                                          = $kernel_object->__( 'Category description' );
			$language['Category Image']                                                                = $kernel_object->__( 'Category Image' );
			$language['Upload category Image']                                                         = $kernel_object->__( 'Upload category Image' );
			$language['Update Product Category']                                                       = $kernel_object->__( 'Update Product Category' );
			$language['No active order found.']                                                        = $kernel_object->__( 'No active order found.' );
			$language['Table Orders']                                                                  = $kernel_object->__( 'Table Orders' );
			$language['Table ID']                                                                      = $kernel_object->__( 'Table ID' );
			$language['Order Status']                                                                  = $kernel_object->__( 'Order Status' );
			$language['Upload User Image']                                                             = $kernel_object->__( 'Upload User Image' );
			$language['%{param} is not support split payment,are you sure to pay only with %{param}?'] = $kernel_object->__( '%{param} is not support split payment,are you sure to pay only with %{param}?' );

			
			$language['A category with the same name already exists with the selected parent.'] = $kernel_object->__( 'A category with the same name already exists with the selected parent.' );
			$language['Tips']                                                                   = $kernel_object->__( 'Tips' );
			$language['Add tips']                                                               = $kernel_object->__( 'Add tips' );
			$language['Adding category']                                                        = $kernel_object->__( 'Adding category' );
			$language['Updating category']                                                      = $kernel_object->__( 'Updating category' );

			
			$language['Tips Log']            = $kernel_object->__( 'Tips Log' );
			$language['Loading tips log...'] = $kernel_object->__( 'Loading tips log...' );
			$language['Entry Date']          = $kernel_object->__( 'Entry Date' );
			$language['Previous Amount']     = $kernel_object->__( 'Previous Amount' );
			$language['Available Tips']      = $kernel_object->__( 'Available Tips' );
			$language['Withdraw Note']       = $kernel_object->__( 'Withdraw Note' );

			
			$language['Parcel Table']                                         = $kernel_object->__( 'Parcel Table' );
			$language['Table Not Engaged']                                    = $kernel_object->__( 'Table Not Engaged' );
			$language['Table Engaged']                                        = $kernel_object->__( 'Table Engaged' );
			$language['Order canceled successfully']                          = $kernel_object->__( 'Order canceled successfully' );
			$language['Cancel Order']                                         = $kernel_object->__( 'Cancel Order' );
			$language['Please add items to apply coupons']                    = $kernel_object->__( 'Please add items to apply coupons' );
			$language['Please add customer to add rewards']                   = $kernel_object->__( 'Please add customer to add rewards' );
			$language['Add waiter']                                           = $kernel_object->__( 'Add waiter' );
			$language['Are you sure to delete this category: %{category}?']   = $kernel_object->__( 'Are you sure to delete this category: %{category}?' );
			$language['Are you sure to delete this attribute: %{attribute}?'] = $kernel_object->__( 'Are you sure to delete this attribute: %{attribute}?' );
			$language['Countries Loading']                                    = $kernel_object->__( 'Countries Loading' );

			
			$language['All Order']                                       = $kernel_object->__( 'All Order' );
			$language['All Refund']                                      = $kernel_object->__( 'All Refund' );
			$language['Withdraw Tips from cash drawer']                  = $kernel_object->__( 'Withdraw Tips from cash drawer' );
			$language['User']                                            = $kernel_object->__( 'User' );
			$language['Choose/Search User']                              = $kernel_object->__( 'Choose/Search User' );
			$language['Are you sure,you want to change sound settings?'] = $kernel_object->__( 'Are you sure,you want to change sound settings?' );
			$language['No placed order found']                           = $kernel_object->__( 'No placed order found' );

			
			$language['Cash Drawer Tips details'] = $kernel_object->__( 'Cash Drawer Tips details' );
			$language['Outlet Stock']             = $kernel_object->__( 'Outlet Stock' );

			
			$language['Order has been served']          = $kernel_object->__( 'Order has been served' );
			$language['Successfully purchased']         = $kernel_object->__( 'Successfully purchased' );
			$language['Placed']                         = $kernel_object->__( 'Placed' );
			$language['Pick']                           = $kernel_object->__( 'Pick' );
			$language['Send To Kitchen']                = $kernel_object->__( 'Send To Kitchen' );
			$language['You can not update paid order']  = $kernel_object->__( 'You can not update paid order' );
			$language['Show Outlet']                    = $kernel_object->__( 'Show Outlet' );
			$language['Click to change sound settings'] = $kernel_object->__( 'Click to change sound settings' );
			...
			$language['End Of The Day Report']      = $kernel_object->__( 'End Of The Day Report' );
			$language['Refund Amount']              = $kernel_object->__( 'Refund Amount' );
			$language['- Opening balance']          = $kernel_object->__( '- Opening balance' );
			$language['- Net cash sale of the day'] = $kernel_object->__( '- Net cash sale of the day' );
			$language['- Total refund of the day']  = $kernel_object->__( '- Total refund of the day' );
			$language['- Expected cash']            = $kernel_object->__( '- Expected cash' );
			$language['- Total sale the day']       = $kernel_object->__( '- Total sale the day' );
			$language['EOD Report']                 = $kernel_object->__( 'EOD Report' );
			$language['Report data is loading']     = $kernel_object->__( 'Report data is loading' );
			$language['Show end of the day report'] = $kernel_object->__( 'Show end of the day report' );

			
			$language['Opening']                      = $kernel_object->__( 'Opening' );
			$language['Changed']                      = $kernel_object->__( 'Changed' );
			$language['Refunded']                     = $kernel_object->__( 'Refunded' );
			$language['- Total withdrawn of the day'] = $kernel_object->__( '- Total withdrawn of the day' );

			
			$language['No table found to make an order. Please add a table first.'] = $kernel_object->__( 'No table found to make an order. Please add a table first.' );

			
			$language['Tips Information'] = $kernel_object->__( 'Tips Information' );
			$language['Total Tips']       = $kernel_object->__( 'Total Tips' );
			$language['Withdrawn Tips']   = $kernel_object->__( 'Withdrawn Tips' );
			$language['Log']              = $kernel_object->__( 'Log' );
			$language['Loading table']    = $kernel_object->__( 'Loading table' );
			$language['Order syncing']    = $kernel_object->__( 'Order syncing' );

			
			$language['Total Tax']          = $kernel_object->__( 'Total Tax' );
			$language['Tax Report Summary'] = $kernel_object->__( 'Tax Report Summary' );

			
			$language['- Drawer counted amount'] = $kernel_object->__( '- Drawer counted amount' );
			$language['Drawer Counted Amount']   = $kernel_object->__( 'Drawer Counted Amount' );

			
			$language['Loading cash drawer data'] = $kernel_object->__( 'Loading cash drawer data' );

			
			$language['Previous Cash Drawer Amount:']                                                             = $kernel_object->__( 'Previous Cash Drawer Amount:' );
			$language['Cash Drawer Closing Counted Amount']                                                       = $kernel_object->__( 'Cash Drawer Closing Counted Amount' );
			$language['Allows users to review and input the counted cash amount from the drawer before closing.'] = $kernel_object->__( 'Allows users to review and input the counted cash amount from the drawer before closing.' );
