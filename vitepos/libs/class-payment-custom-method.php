...
class Payment_Custom_Method extends Payment_Method_Base {
	 ...
	 * @param array  $fields It's field param.
	 * @param string $comp It's comp param.
	 */
	public function set_customization( $id, $title, $icon = '', $fields = array(), $comp = 'basic' ) {
		if ( empty( $icon ) ) {
			$icon = 'vps vps-star-o';
		}
		...
		if ( ! empty( $fields ) ) {
			foreach ( $fields as $field ) {
				...
				$this->add_field( $field->title, $fld_id, 'Y' == $field->is_req, $field->type, $is_show );
			}
