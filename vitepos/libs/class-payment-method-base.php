...
abstract class Payment_Method_Base {
	...
	public $h_comp = '';
	/**
	 * Its property kiosk_des
	 *
	 * @var string
	 */
	public $kiosk_des = '';
	/**
	 * Its property allow_kiosk
	 *
	 * @var boolean
	 */
	public $allow_kiosk = false;
	/**
	 ...
	 * @param int|string $outlet_id It's outlet id.
	 * @param int|string $counter_id It's counter id.
	 *
	 * @return mixed
	 */
