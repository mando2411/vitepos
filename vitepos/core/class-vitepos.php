...
use VitePos\Api\V1\Pos_Report_Api;
...
/**
 * Its the kernel class file
 */
require_once __DIR__ . '/../../vendor/autoload.php';
/**
 * Is the vendor autoload class file
 */
require_once __DIR__ . '/../../vendor/autoload.php';
/**
...
class VitePos extends Kernel {
		...
		if ( appsbd_is_activated_plugin( 'woocommerce/woocommerce.php' ) ) {
			...
			add_action(
				...
				function () {
					...
					new Pos_Report_Api( $namespace, $this );
					/**
	...
	public function dci_init() {
		if ( function_exists( 'vitepos_dci_dynamic_init' ) ) {
	...
	public function register_modules() {
		...
		$this->add_module( 'VitePos\Modules\MU_Plugin_Settings' );
	}
	...
	public function on_admin_scripts() {
		...
		$jv_object->time_format                                = get_option( 'time_format' );
		...
		$jv_object->wc_version                                 = function_exists( 'WC' ) ? WC()->version : '';
